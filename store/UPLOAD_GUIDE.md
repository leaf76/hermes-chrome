...
Current version: **1.8.1** → `hermes-chrome-v1.8.1.zip`
(GitHub Release asset: `hermes-chrome-extension-v1.8.1.zip` — same package)
...
2. Reload unpacked extension from this repo’s `extension/` and smoke-test:
   ```bash
   hermes-chrome --json bridge-status   # extension_connected + version 1.8.1
...
3. **Package** → Upload new package:
   - Local: `store/dist/hermes-chrome-v1.8.1.zip`
   - Or download: https://github.com/leaf76/hermes-chrome/releases/download/v1.8.1/hermes-chrome-extension-v1.8.1.zip
4. **Store listing**
